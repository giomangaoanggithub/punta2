...
(15, 'newgioadmin@gmail.com', 'noobteacher@gmail.com', 0);
...
(1, 'What happened to the story of the three little pigs?', 50, '2023-02-12 06:23:44', '2023-03-24 23:59:00', 'englishteacher@gmail.com', '2', 0, '<!@#CORRECT$%^>', 'response'),
(3, 'Is distance the same as displacement? Explain Why?', 20, '2023-02-12 06:23:44', '2023-03-24 23:59:00', 'scienceteacher@gmail.com', '1', 1, '<!@#CORRECT$%^>', 'response'),
(4, 'Which house that hasn\'t blown off by the big bad wolf?', 15, '2023-02-12 06:23:44', '2023-03-24 23:59:00', 'englishteacher@gmail.com', '2', 0, '<!@#CORRECT$%^>', 'response'),
(5, 'yolo', 60, '2023-02-12 13:29:16', '2023-03-24 23:59:00', 'gioteacher@gmail.com', '3', 1, '<!@#CORRECT$%^>', 'response'),
(6, 'yolo doggo', 20, '2023-02-12 14:20:44', '2023-03-24 23:59:00', 'gioteacher@gmail.com', '4', 1, '<!@#CORRECT$%^>', 'response'),
(29, 'eee', 15, '2023-02-20 22:22:21', '2023-03-24 23:59:00', 'gioteacher@gmail.com', '4', 0, '<!@#CORRECT$%^>', 'response'),
(30, 'finally', 10, '2023-02-20 22:46:34', '2023-03-24 23:59:00', 'gioteacher@gmail.com', '3', 1, '<!@#CORRECT$%^>', 'response'),
(31, 'lol', 65, '2023-02-20 22:56:54', '2023-03-24 23:59:00', 'gioteacher@gmail.com', '3', 0, '<!@#CORRECT$%^>', 'response'),
(32, 'testing123', 100, '2023-02-20 23:20:00', '2023-03-24 23:59:00', 'gioteacher@gmail.com', '3', 0, '<!@#CORRECT$%^>', 'response'),
...
(69, 'qqwwee', 50, '2023-03-12 11:14:30', '2023-03-24 23:59:00', 'gioteacher@gmail.com', '3', 1, '<!@#CORRECT$%^>', 'response'),
(70, 'yo by new teacher', 20, '2023-03-13 21:05:50', '2023-03-24 23:59:00', 'newteacher@gmail.com', '12', 0, '<&^>dfgdfgd  dfgdf  <&^>dfgdfgd  <!@#CORRECT$%^><&*>erferferf  <&*>e  e  <&*>erferferf  ', 'response'),
(84, 'question for fam room', 25, '2023-04-02 03:44:26', '2023-04-05 23:59:00', 'gioteacher@gmail.com', '11', 1, '', 'factual-recall'),
(93, 'creare', 20, '2023-04-02 08:14:48', '2023-04-06 23:59:00', 'gioteacher@gmail.com', '11', 1, '<!@#CORRECT$%^><!@#INCORRECT$%^><!@#ENUMERATE$%^><&**>wecwewec<&**> wefw<&**> wefwef', 'factual-recall');
...
--
ALTER TABLE `admin_teacher_conn`
  MODIFY `a_t_c_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
